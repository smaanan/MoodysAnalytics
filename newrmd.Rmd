...
Since the area under the curve occupies about 74 percent of the figure, and knowing that an AUC of 50 percent refers to the random guess line, we can conclude that our model performs better compared to random guessing.
